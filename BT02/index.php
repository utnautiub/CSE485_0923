                ...
                <div class="nav-menu">
                    <ul class="nav flex-column">
                        <?php for ($i = 0; $i < $amount_nav; $i += 1) { ?>
                            <li class="nav-item">
                                <a id="menu-item" class="nav-link position-relative" href="./nav-menu/<?= $list_nav[$i]?>.php#<?= $list_nav[$i] ?>"> <span><i class="<?= $list_icon[$i%$amount_icon] ?>"></i></span> <?= $list_nav[$i] ?> <span class="span-caret position-absolute" ><i class="bi bi-caret-right-fill"></i></span></a>
                            </li>
                        <?php } ?>
                    </ul>
                </div>
