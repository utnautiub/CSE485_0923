...
<div class="container">
    ...
    <form action="../../services/PatientService.php" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="dateOfBirth" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Moblie</label>
